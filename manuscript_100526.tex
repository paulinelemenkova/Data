...
\begin{figure}[H]
    ...
    \includegraphics[width=\textwidth]{Fig_04.png} 
    \caption{Geophysical Data Processing Framework: Istanbul EEW \& Seismic Analysis. Diagram source: authors.}
    \label{fig03}
\end{figure}
