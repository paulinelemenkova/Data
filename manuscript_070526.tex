...
\abstract{The Marmara region of Türkiye, situated along the complex North Anatolian Fault Zone (NAFZ), represents one of the most seismically active and monitored zones globally. Given the region's high vulnerability and the catastrophic impacts of historical events, such as the 1999 İzmit and 2023 Kahramanmaraş sequences, there is a critical need for advanced seismic hazard risk assessment (SHRA). This research explores the paradigm shift from traditional geophysics to big data seismology, characterized by the "Five Vs": volume, velocity, variety, veracity, and value. The study highlights how the integration of Artificial Intelligence (AI), cloud computing, and high-performance computing (HPC) enables the real-time processing of petabyte-scale sensor streams of seismic signals for geophysical modelling. We discuss the implementation of a "Medallion Architecture" on cloud-native platforms like Databricks to transition raw seismic waveforms into actionable insights through structured Bronze, Silver, and Gold data tiers. Key technological advancements, including Physics-Informed Neural Networks (PINNs) and Deep Learning models like PhaseNet, are analyzed for their ability to enhance Earthquake Early Warning (EEW) systems by providing sub-second phase picking and automated event detection.  By addressing computational bottlenecks through hybrid mosaic architectures and edge computing, this framework aims to maximize the "Golden Seconds" of warning for Istanbul’s critical infrastructure. Ultimately, this paper provides a roadmap for bridging the gap between traditional data analysis and predictive analytics to enhance societal safety in the Marmara region. This contribution underscores the vital role of interdisciplinary data management and high-performance computing in maximizing the "Golden Seconds" of warning, ultimately improving the long-term resilience of seismically active urban zones.}
